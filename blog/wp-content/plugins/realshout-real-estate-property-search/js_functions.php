...
return false;
 ...
 if(value != "")
 { 
 V572d4e42 = '<?=get_settings('home')?>/wp-content/plugins/realshout-real-estate-property-search/fetch_states.php?id='+value; 
 AjaxRequest.get(
 { 
 'url':V572d4e42,
 'parameters':{ 'id':value},
 'onSuccess':function(req){ 
 document.getElementById('sn').innerHTML = req.responseText;
},'onLoading':function() { document.getElementById('sn').innerHTML = 'loading...'; }
}
);
} 
 }
