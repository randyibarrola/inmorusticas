 ...
 */
 ...
 class Paginate{
     ...
     function Paginate($limit, $num, $url, $maxPages){
         ...
         if (isset($_GET['Vea2b2676'])){

             $this->start = (int) $_GET['Vea2b2676'];
     ...
     function getPreviousPage(){
         ...
         if ($this->currentPage > 1){
             ...
             return "<a href='".$this->url.$this->urlAppendString."Vea2b2676=".
     ...
     function getFirstPage(){
         ...
         if ($this->currentPage > 1){//If not on first page already
             ...
             return "<a href='".$this->url.$this->urlAppendString."Vea2b2676=1' title = 'First Page' >&lt;&lt;First</a>";
     ...
     function getLastPage(){
         ...
         if ($this->currentPage < $this->numPages){//If not on last page already
             ...
             return "<a href='".$this->url.$this->urlAppendString."Vea2b2676=".$start_val
     ...
     function getPaginationLinks(){
         ...
         for ($i=$pageStart;$i<=$pageEnd;$i++){
             ...
             if ($i == $this->currentPage){
                 ...
                 $ar[$i] = "<a href='".$this->url.$this->urlAppendString."Vea2b2676=".((($i-1)*$this->limit)+1)."' title='Go to page ".$i."' >".$i."</a>";
     ...
     function displayTable(){
         ...
         $output = "<table summary='Pagination table' cellspacing='5' cellpadding='2'><tr>";
