...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../img/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../img/');	//accept relative path only
	...
	define('CONFIG_LANG_DEFAULT', (CONFIG_QUERY_STRING_ENABLE && !empty($_GET['language']) && file_exists(DIR_LANG . secureFileName($_GET['language']) . '.php')?secureFileName($_GET['language']):'es')); //change it to be your language file base name, such en
?>