<?
	...
	define("LBL_CURRENT_FOLDER_PATH", 'Ruta Raiz:');
	define('LBL_FOLDER_ROOT',"/");
	...
	define("LBL_BTN_UPLOAD", 'Subir imagen');
	...
	define('LBL_BTN_VIEW_THUMBNAIL','Vista previa');
	define('LBL_ACTION_SELECT_ALL',"Seleccionar todos");
	define('LBL_BTN_VIEW_OPTIONS',"Opciones");
	define('LBL_BTN_VIEW_DETAILS',"Detalles");
	define('LBL_SEARCH',"Buscar");
	define('LBL_SEARCH_FOLDER',"Directorio");
	define('LBL_SEARCH_MTIME',"Por fecha");
	define('LBL_SEARCH_RECURSIVELY','En todos sitios');
	define('LBL_RECURSIVELY_YES',"S&iacute;");
	define('LBL_RECURSIVELY_NO',"No");
	define('LBL_SEARCH_NAME',"Nombre");
	define('PAGINATION_ITEMS_PER_PAGE',"Nivel");
	define('PAGINATION_NEXT',"&raquo;");
	define('PAGINATION_LAST',"&raquo;|");
	define('BTN_SEARCH',"Buscar");
	define('FOLDER_FORM_TITLE',"Nuevo directorio");
	define('FOLDER_LBL_TITLE',"Nombre:");
	define("FOLDER_LBL_CREATE","Crear");
	define('FILE_FORM_TITLE',"Subir ficheros (+ para varios)");
	...
	define('SEARCH_ALL_FILE_TYPES', 'Todo tipo de ficheros');
	define('MENU_SELECT',"USAR ESTA");
	define('PAGINATION_FIRST',"|&lt;&laquo;");
	define('PAGINATION_PREVIOUS',"&laquo;");
	define('THICKBOX_NEXT',"Siguiente");
	define('THICKBOX_CLOSE',"Cerrar previsualizaci&oacute;n");
