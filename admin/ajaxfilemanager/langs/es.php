<?
	...
	define('ERR_FILE_TYPE_NOT_ALLOWED', 'No est&aacute; permitido subir archivos de ese tipo.');
	...
	define('LBL_CURRENT_FOLDER_PATH',"Ruta actual");
	define('LBL_FOLDER_ROOT',"Principal");
	define('LBL_ACTION_SELECT_ALL',"Seleccionar todos");
	define('LBL_BTN_VIEW_DETAILS',"Ver por detalles");
	define('LBL_BTN_VIEW_THUMBNAIL',"Ver por previsualizaci&oacute;n");
	define('PAGINATION_ITEMS_PER_PAGE',"Elementos por pag.");
	define('LBL_BTN_VIEW_OPTIONS',"Opciones de vista");
	define('LBL_SEARCH',"Buscar");
	define('LBL_SEARCH_NAME',"Nombre");
	define('LBL_SEARCH_FOLDER',"Directorio");
	define('LBL_SEARCH_MTIME',"Fecha modificado");
	define('LBL_SEARCH_RECURSIVELY',"B&uacute;squeda Recursiva");
	...
	define('SEARCH_TYPE_UNKNOWN', 'Desconocido');
	define('SEARCH_TYPE_XML', 'XML');
	define('SEARCH_ALL_FILE_TYPES', 'Todos los conocidos');
	define('NEW_FILE_FORM_TITLE', 'Nuevo fichero');
	define('NEW_FILE_LBL_TITLE', 'Nombre:');
	define('NEW_FILE_CREATE', 'Crear');
	define('FILE_FORM_TITLE',"Subir ficheros [+] para a&ntilde;adir");
	define('FILE_LABEL_SELECT',"Seleccionar fichero");
	define('FILE_LBL_UPLOAD',"Subir");
