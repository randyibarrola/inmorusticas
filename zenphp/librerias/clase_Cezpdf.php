...
$pdf->ezText("zenphp\n\n",24);
$pdf->ezImage('zenphp/contenido/img/img08.jpg',132,72,'none','center'); 
...
// | zenphp.es
// +----------------------------------------------------------------------
if (!zen___carga_clase('Cpdf')) die("No encuentro la clase Cpdf en el directorio de librerias de zenphp!");
